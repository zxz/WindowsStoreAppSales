...
//  Store
//
//  Created by XiZhong Zou on 2/12/13.
...
- (void)viewDidLoad
{
    ...
    cells=[[CurrencyManager sharedManager]availableCurrencies];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cell.textLabel.text isEqualToString:[[CurrencyManager sharedManager]baseCurrency]]) {
